...
void WaveSolver::Solve(matrix_t matrix)
{
    ...
    randomize_matrix(matrix, SIZEX, SIZEY);
    start_finish_matrix(matrix, SIZEX, SIZEY, &x_f, &y_f);
...
//    print_matrix(data, SIZEX, SIZEY);
    //printf("\n");
    //sleep(1);
    if (fill_matrix (matrix, SIZEX, SIZEY)) {
        //printf("bad matrix\n");
    return;
    }
...
//    print_matrix_d(data, SIZEX, SIZEY);
    ...
    path_matrix(matrix, SIZEX, SIZEY, x_f, y_f);
    //print_matrix(data, SIZEX, SIZEY);
}
